...
from utils.jsinterp import JSInterpreter
...
def get_initial_function_name(js: str) -> str:
    ...
    raise RegexMatchError(caller="get_initial_function_name", pattern=f"multiple")
            ...
            if idx:
                ...
                if n_func_found:
                    ...
                    raise RegexMatchError(
                        ...
                        pattern=f"{n_func}, does not match the one found",
                    )

                raise RegexMatchError(
                    caller="get_throttling_function_name",
                    pattern=f"{n_func_check_pattern}",
                )

    raise RegexMatchError(caller="get_throttling_function_name", pattern=f"multiple")
